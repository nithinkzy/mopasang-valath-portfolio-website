<?php /* Template Name: Acrylic*/ ?>
<?php
function water_meta_tags()
{
    echo '<meta name="description" content="Welcome to My Acrylic Painting Gallery, showcasing stunning artwork from some of the finest water color painters in the country. Explore our selection of beautiful, vibrant paintings that will bring color and joy to any home or office. Buy now and enjoy a lifetime of beauty." />';
}
add_action('wp_head', 'water_meta_tags');
get_header();

global $wpdb;
$water_color_db = $wpdb->get_results("select * from acrylic");
$imageDir = get_template_directory_uri() . '/assets/images/acrylic/';
...
<section id="water__color">
    <div class="container-fluid">
        <div class="mb-5" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center">
            <h1 class="text-center mb-4 main-title">Acrylic Paintings</h1>
            <p class="lead text-center mb-5 lead-title">Experience my Colorful World of Acrylic Art!</p>
        </div>
        <div data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" data-aos-anchor-placement="top-center" class="gallery d-flex flex-wrap  ">
            ...
            foreach ($water_color_db as $key => $obj) {
                ...
                $directory = get_template_directory() . '/assets/images/acrylic/' . $filename;
            ...
            ?>
                    <div class="gallery__wrapper col-12 col-md-6 col-lg-4 col-xl-3 px-2 mb-4  align-self-start">
                        ...
                        <div class="gallery__image">
                            ...
                            <a href="<?php echo $imageDir . $filename ?>" data-lightbox="Arylic Painting Gallery" data-title="<?php echo $title ?>">

                                <img class="img-fluid frame mb-5 " src="<?php echo $imageDir . $filename ?>" alt="">
                            </a>
